"use client";
import { ArrowRight, Check, CheckCircle, Mail, User } from "lucide-react";
        ...
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for your interest in Platter. You will receive an email
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              RestaurantQR helps you modernize your restaurant with digital
              menus, contactless ordering, and insightful analytics.
            </p>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Get started with RestaurantQR today
                  </p>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                We'll review and approve your access
              </p>
            </div>
            <div className="text-center">
              <div className="bg-primary/10 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Begin transforming your restaurant
              </p>
            </div>
          </div>
        </div>
