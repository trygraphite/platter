      ...
      <div className="container-wide">
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-4 max-w-3xl mx-auto">
            Platter provides free QR code menu systems and waiter apps for
            restaurants worldwide. Our complete digital menu solution helps
            restaurants increase efficiency, reduce wait times, and boost
            revenue. Create your free QR code menu today and join thousands of
            successful restaurants across the globe.
          </p>
        </div>
      </div>
    </footer>
