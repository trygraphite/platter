  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 md:pt-20 lg:pt-24">
      <div className="container-wide">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center my-4 lg:my-24 pb-14">
          <div className="flex flex-col gap-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900">
              Create a Free
              <span className="block text-primary">QR Code Menu</span>& Waiter
              App
            </h1>
            <p className="text-lg text-gray-600 max-w-xl">
              Create your digital restaurant menu with QR codes in minutes, no
              credit card required. Includes ordering system and staff
              management tools.
            </p>
