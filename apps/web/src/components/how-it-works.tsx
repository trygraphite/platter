      ...
      <div className="container-wide">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
            Free QR Code Menu System - Transform your restaurant with our digital menu solution in three simple steps
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative mb-24 lg:mb-32 last:mb-0">
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                <div className={`flex flex-col gap-6 ${index % 2 === 1 ? 'lg:items-end lg:text-right' : ''}`}>
                  <div className="flex items-center gap-4">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-100 text-primary">
                      <span className="text-xl font-bold border p-2 px-4 border-primary rounded-full">{index + 1}</span>
                    </div>
                  ...
                  <ul className="mt-2 space-y-2">
                    {step.features.map((feature) => (
                      <li key={feature} className="flex items-center gap-3">
                        <svg className="h-5 w-5 flex-none text-primary" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:order-first' : ''}`}>
                  <div className="relative z-10 flex justify-center">
                    ...
                    <div className={`w-full max-w-[400px] ${step.illustrationClass}`}>
                      {step.illustration}
                    </div>
                  </div>
                </div>
...
const steps = [
  {
    ...
    description: 'Customers scan the QR code with their phone camera to instantly view your digital menu',
    features: [
      'Instant menu access',
  ...
  },
  {
    ...
    description: 'Customers select items and pay using their preferred payment method',
    features: [
      'Easy item selection',
  ...
  },
  {
    ...
    description: 'Get instant notifications and manage orders through your restaurant dashboard',
    features: [
          ...
          <div className="mt-2">
            ...
            <div className="bg-white p-2 rounded-md shadow-sm mb-2">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center text-white text-xs">T1</div>
                <div>
            ...
            <div className="bg-white p-2 rounded-md shadow-sm">
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-secondary flex items-center justify-center text-white text-xs">T2</div>
                <div>
