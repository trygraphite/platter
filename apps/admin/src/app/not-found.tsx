...
import { Home, Utensils, ChefHat, Search } from "lucide-react";
              ...
              <div className="flex flex-col items-center space-y-8 text-center">
                <div className="space-y-3">
                  ...
                  <p className="mx-auto max-w-[700px] text-gray-500 dark:text-gray-400 md:text-xl">
                    The page you're looking for doesn't exist or has been moved from our menu.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-center items-center space-x-2">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Need assistance? Contact our support team for immediate help with your Platter Admin dashboard.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-lg w-full max-w-2xl mt-12">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <Link href="/menu" className="text-blue-600 dark:text-blue-400 hover:underline">Menu Items</Link>
                    <Link href="/orders" className="text-blue-600 dark:text-blue-400 hover:underline">Orders</Link>
                    ...
                    <Link href="/complaints" className="text-blue-600 dark:text-blue-400 hover:underline">complaints</Link>
