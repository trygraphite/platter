...
export async function updateCategoryPosition(userId: string, categoryId: string, direction: "up" | "down") {
  try {
...
export async function updateMenuItemPosition(userId: string, menuItemId: string, direction: "up" | "down") {
  try {
...
export async function updateCategoryGroupPosition(userId: string, groupId: string, direction: "up" | "down") {
  try {
    ...
    return { success: false, error: "Failed to update category group position" };
  }
}